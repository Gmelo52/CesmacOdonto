      ...
      <View style={styles.contDesc}>
        <View style={styles.viewText}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            As mudanças físicas preparam a mulher para o parto e a amamentação, afinal,
o corpo está se preparando para desenvolver um novo ser humano.
Essas mudanças repercutem em diversos segmentos, e, entre elas, estão:{"\n"}{"\n"}
Primeiro Trimeste:{"\n"}
- Enjoos matinais;{"\n"}
- Aumento dos seios;{"\n"}
...
- Inchaço dos tornozelos (pela diminuição do retorno venoso).{"\n"}
- Relaxamento dos ligamentos do corpo;{"\n"}{"\n"}
Terceiro Trimestre:{"\n"}
- Pressão sobre a bexiga;{"\n"}
- Aumento da frequência urinária;{"\n"}
- Diminuição do volume respiratório (pela compressão do diafragma);{"\n"}
            </Text>
